...
class Segmentador extends Model
{
	...
	$process = Process::fromShellCommandline('/usr/bin/python3 ../app/developer_docs/segmentacion-core/lados_completos/lados_completos.py $tabla $prov $dpto $frac $rad $min $max $deseada $indivisible usar_todos_juntos costo_cuadrático_mzas',null,['PYTHONIOENCODING' => 'utf8',
